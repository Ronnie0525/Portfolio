...
const CartlyMockup = () => (
  <div className="absolute inset-0 flex flex-col bg-white">
    ...
    <div className="mx-3 rounded-lg px-2.5 py-1.5 mb-1.5 bg-gradient-to-r from-orange-500 to-amber-500"><div className="text-[8px] font-bold text-black">Deals 🔥</div><div className="text-[6px] text-black/80">Up to 60% off</div></div>
