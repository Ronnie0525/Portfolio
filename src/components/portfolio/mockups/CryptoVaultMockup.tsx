...
const CryptoVaultMockup = () => (
  <div className="absolute inset-0 flex flex-col" style={{ background: "#0D1117" }}>
    <div className="flex items-center justify-between px-3 pt-1.5 pb-1">
      <span className="text-[7px] font-medium text-black/50">9:41</span>
    ...
    <div className="flex items-center justify-between px-3 py-1.5">
      ...
      <div className="flex items-center gap-2">
        <div className="relative"><Bell className="w-3 h-3 text-black/40" /><div className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 rounded-full bg-red-500" /></div>
    ...
    <div className="mx-3 rounded-xl p-2.5 border border-white/10" style={{ background: "rgba(124,92,252,0.15)" }}>
      <div className="text-[7px] text-black/40">Total Balance</div>
    ...
    <div className="flex items-center justify-around px-3 py-1.5 border-t border-white/[0.06]">
      ...
      <BarChart2 className="w-3 h-3 text-black/20" /><ArrowLeftRight className="w-3 h-3 text-black/20" /><Wallet className="w-3 h-3 text-black/20" /><User className="w-3 h-3 text-black/20" />
    </div>
  </div>
);
