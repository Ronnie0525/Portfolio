...
const CryptoVaultMockup = () => (
  <div className="absolute inset-0 flex flex-col" style={{ background: "#0D1117" }}>
    <div className="flex items-center justify-between px-3 pt-1.5 pb-1">
      <span className="text-[7px] font-medium text-black/80">9:41</span>
    ...
    <div className="flex items-center justify-between px-3 py-1.5">
      <span className="text-[9px] font-bold text-black">CryptoVault</span>
      <div className="flex items-center gap-2">
        <div className="relative"><Bell className="w-3 h-3 text-black/75" /><div className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 rounded-full bg-red-500" /></div>
    ...
    <div className="mx-3 rounded-xl p-2.5 border border-black/15" style={{ background: "rgba(124,92,252,0.15)" }}>
      <div className="text-[7px] text-black/75">Total Balance</div>
      <div className="flex items-baseline gap-1.5">
        <span className="text-lg font-bold text-black" style={{ fontFamily: "Space Grotesk" }}>$24,580</span>
    ...
    <div className="flex-1 px-3 py-1.5 space-y-1">
      {[
        ...
        <div key={c.name} className="flex items-center gap-1.5 py-1 px-2 rounded-lg bg-black/5 border border-black/10">
          <div className="w-5 h-5 rounded-full flex items-center justify-center text-[7px] font-bold text-black" style={{ background: `${c.color}30` }}>{c.sym}</div>
          <div className="flex-1"><div className="text-[8px] font-semibold text-black">{c.name}</div></div>
          ...
          <div className="text-right"><div className="text-[7px] font-bold text-black">{c.price}</div><div className={`text-[6px] font-medium ${c.up ? "text-emerald-400" : "text-red-400"}`}>{c.pct}</div></div>
        </div>
      ))}
    </div>
    <div className="px-3 pb-1 flex gap-2">
      <div className="flex-1 py-1.5 rounded-lg text-center text-[8px] font-bold text-black bg-emerald-500/80">Buy</div>
      <div className="flex-1 py-1.5 rounded-lg text-center text-[8px] font-bold text-black bg-red-500/80">Sell</div>
    </div>
    <div className="flex items-center justify-around px-3 py-1.5 border-t border-black/15">
      ...
      <BarChart2 className="w-3 h-3 text-black/65" /><ArrowLeftRight className="w-3 h-3 text-black/65" /><Wallet className="w-3 h-3 text-black/65" /><User className="w-3 h-3 text-black/65" />
    </div>
  </div>
);
