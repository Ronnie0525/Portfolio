...
const ThreadsMockup = () => (
  <div className="absolute inset-0 flex flex-col" style={{ background: "#FAF9F6" }}>
    ...
    <div className="flex items-center justify-between px-3 py-1.5">
      ...
      <div className="flex items-center gap-2"><Search className="w-3 h-3 text-black/40" /><Heart className="w-3 h-3 text-black/40" /><div className="relative"><ShoppingBag className="w-3 h-3 text-black/40" /><div className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-red-500 flex items-center justify-center text-[5px] text-black font-bold">2</div></div></div>
    </div>
